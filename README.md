...
```
https://<your-username>.github.io/Magic-8-Ball-Support/
```
...
If the Apple payment sheet closed without a confirmation, you were not charged. For billing issues visit [reportaproblem.apple.com](https://reportaproblem.apple.com).
...
## 🚀 Deploying the Support Page via GitHub Pages

1. Push `index.html` to this repository's `main` branch (root directory)
2. Go to **Settings → Pages**
3. Under **Source**, select `Deploy from a branch` → `main` → `/ (root)`
4. Click **Save** — your site will be live in ~60 seconds at `https://<username>.github.io/Magic-8-Ball-Support/`
5. Use that URL as your **Support URL** in App Store Connect
